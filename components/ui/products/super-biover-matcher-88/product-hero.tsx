...
interface HeroSuperBioverMatcher88Props {
    eyebrow: string
    heading: string
    description: string
    image: Image
...
type Props = Partial<HeroSuperBioverMatcher88Props>

const defaultProps: HeroSuperBioverMatcher88Props = {
    image: {
        src: assets.super_biover_matcher88,
        alt: 'Super Biover Matcher 8.8',
    },
    eyebrow: 'MATCHING ENGINE',
    heading: 'Super Biover Matcher 8.8',
    description: 'Next-Generation Neural Biometric Matching',
}

const HeroSuperBioverMatcher88 = (props: Props) => {
    const {
        image,
        eyebrow,
        heading,
...
export { HeroSuperBioverMatcher88 }
...
interface HeroAdintMassCollectionProps {
    eyebrow: string
    heading: string
    description: string
    image: Image
...
type Props = Partial<HeroAdintMassCollectionProps>

const defaultProps: HeroAdintMassCollectionProps = {
    image: {
        src: assets.adint_mass_collection,
        alt: 'ADINT Mass Collection',
    },
    eyebrow: 'DATA INTELLIGENCE',
    heading: 'ADINT Mass Collection',
    description: 'Capturing massive data on a global scale remotely with six months of historical insights',
}

const HeroAdintMassCollection = (props: Props) => {
    const {
        image,
        eyebrow,
        heading,
...
export { HeroAdintMassCollection }
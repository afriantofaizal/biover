...
interface HeroSuperBioverMatcher42Props {
    eyebrow: string
    heading: string
    description: string
    image: Image
...
type Props = Partial<HeroSuperBioverMatcher42Props>

const defaultProps: HeroSuperBioverMatcher42Props = {
    image: {
        src: assets.super_biover_matcher42,
        alt: 'Super Biover Matcher 4.2',
    },
    eyebrow: 'MATCHING ENGINE',
    heading: 'Super Biover Matcher 4.2',
    description: 'Proven Enterprise Matching Foundation',
}

const HeroSuperBioverMatcher42 = (props: Props) => {
    const {
        image,
        eyebrow,
        heading,
                ...
                className="mb-16 flex w-full flex-col items-start text-left">
                    ...
                    <FadeUp controlled duration={0.7} distance={24} >
                        <div className="mb-6 flex flex-col items-center gap-1.5">
                            <span className="h-px w-42 bg-linear-to-r from-transparent via-blue-500 to-transparent translate-x-3" />
                                <span
                                    className="
                                        text-lg
                                        font-medium
...
export { HeroSuperBioverMatcher42 }
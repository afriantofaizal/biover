...
interface ProductSuperBioverMatcher42Props {
  product?: ProductSectionData
}

type Props = Partial<ProductSuperBioverMatcher42Props>

const defaultProduct: ProductSectionData = {
    image: {
        src: assets.super_biover_matcher42_1,
        alt: 'Super Biover Matcher 4.2',
    },
    overview: 'Super Biover Matcher 4.2 is the battle-tested workhorse of biometric matching systems, deployed in over 60 national ABIS implementations worldwide. Combines algorithmic stability with proven accuracy, optimized for high-reliability environments where consistency and auditability are paramount. Fully certified against international biometric standards.',
    capabilities: [
        {
        title: 'NIST-certified minutiae matching algorithms',
        },
        {
        title: 'Deterministic matching for audit compliance',
        },
        {
        title: 'Support for legacy and modern sensor formats',
        },
        {
        title: 'Template interoperability (ISO/ANSI)',
        },
        {
        title: 'Hot-swappable algorithm plugins',
        },
        {
        title: 'Comprehensive match score reporting',
        },
    ],
    useCases: [
        {
        ...
        {
        title: 'Healthcare patient matching',
        },
    ],
}

const ProductSuperBioverMatcher42 = (props: Props) => {
    const { product } = {
...
export { ProductSuperBioverMatcher42 }
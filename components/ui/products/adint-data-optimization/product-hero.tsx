...
interface HeroAdintDataOptimizationProps {
    eyebrow: string
    heading: string
    description: string
    image: Image
...
type Props = Partial<HeroAdintDataOptimizationProps>

const defaultProps: HeroAdintDataOptimizationProps = {
    image: {
        src: assets.adint_data_optimization,
        alt: 'ADINT Data Optimization',
    },
    eyebrow: 'DATA INTELLIGENCE',
    heading: 'ADINT Data Optimization',
    description: "Once data is collected into the system, Biover's experts begin to study, analyze, and enhance the compiled data",
}

const HeroAdintDataOptimization = (props: Props) => {
    const {
        image,
        eyebrow,
        heading,
...
export { HeroAdintDataOptimization }
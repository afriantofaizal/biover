...
interface ProductAdintDataOptimizationProps {
  product?: ProductSectionData
}

type Props = Partial<ProductAdintDataOptimizationProps>

const defaultProduct: ProductSectionData = {
    image: {
        src: assets.adint_data_optimization1,
        alt: 'ADINT Data Optimization',
    },
    overview: 'ADINT Data Optimization applies machine learning and entity resolution to raw advertising intelligence, producing high-confidence identity profiles and risk signals. Deduplicates device graphs, resolves cross-device identities, and enriches profiles with behavioral and demographic attributes for downstream fraud prevention and identity verification systems.',
    capabilities: [
        {
        title: 'Multi-device identity graph resolution',
        },
        {
        title: 'Behavioral segmentation engine',
        },
        {
        title: 'Anomaly detection and synthetic ID flagging',
        },
        {
        title: 'Demographic and interest inference',
        },
        {
        title: 'Privacy-preserving data normalization',
        },
        {
        title: 'RESTful API with sub-second response',
        },
    ],
    useCases: [
        {
        ...
        {
        title: 'Enhanced KYC/AML',
        },
        {
        title: 'Threat intelligence feeds',
        },
        {
        title: 'Identity proofing services',
        },
    ],
}

const ProductAdintDataOptimization = (props: Props) => {
    const { product } = {
...
export { ProductAdintDataOptimization }
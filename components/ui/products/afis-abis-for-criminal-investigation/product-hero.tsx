...
type Props = Partial<HeroAfisAbisProps>

const defaultProps: HeroAfisAbisProps = {
    image: {
        src: assets.afis_abis,
        alt: 'AFIS/ABIS for Criminal Investigation',
    },
    eyebrow: 'LAW ENFORCEMENT',
    heading: 'AFIS/ABIS for Criminal Investigation',
    description: 'Forensic-Grade Identity Intelligence Platform',
}

const HeroAfisAbis = (props: Props) => {
    const {
        image,
        eyebrow,
        heading,

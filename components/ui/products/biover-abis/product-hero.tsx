...
type Props = Partial<HeroBioverAbisProps>

const defaultProps: HeroBioverAbisProps = {
    image: {
        src: assets.biover_abis,
        alt: 'Biover ABIS',
    },
...
const HeroBioverAbis = (props: Props) => {
    const {
        image,
        eyebrow,
        heading,

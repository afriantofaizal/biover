...
interface ProductBioverAbisProps {
  product?: ProductSectionData
}

type Props = Partial<ProductBioverAbisProps>

const defaultProduct: ProductSectionData = {
    image: {
        src: assets.biover_abis1,
        alt: 'Biover ABIS',
    },
    overview: 'Biover ABIS is a comprehensive automated biometric identification system designed for national-scale deployments. Built on distributed architecture, it handles millions of daily transactions with multi-modal biometric matching across fingerprint, face, and iris modalities. Features enterprise-grade redundancy, real-time deduplication, and compliance with international biometric standards.',
    capabilities: [
        {
        title: 'Multi-modal biometric fusion engine',
        },
        {
        title: 'Real-time duplicate detection',
        },
        {
        title: 'Distributed processing cluster (up to 128 nodes)',
        },
        {
        title: 'Automated quality assessment (NFIQ2)',
        },
        {
        title: 'Advanced encryption (AES-256, TLS 1.3)',
        },
        {
        title: 'API-first architecture (REST, gRPC, SOAP)',
        },
    ],
    useCases: [
        {
...
const ProductBioverAbis = (props: Props) => {
    const { product } = {
